...
<div class="parameter">
    Project name/ID:
    <strong><props:displayValue name="${keys.projectNameOrIdPropertyName}" emptyValue="not specified"/></strong>
</div>

<div class="parameter">
    Environment names/IDs:
    <strong><props:displayValue name="${keys.environmentIdsOrNamesPropertyName}" emptyValue="not specified"/></strong>
</div>
